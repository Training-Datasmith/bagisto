...
use Webkul\Admin\Http\Controllers\Customers\Address_Controller;
use Webkul\Admin\Http\Controllers\Customers\Customer\Cart_Controller;
use Webkul\Admin\Http\Controllers\Customers\Customer\Compare_Controller;
use Webkul\Admin\Http\Controllers\Customers\Customer\Order_Controller;
use Webkul\Admin\Http\Controllers\Customers\Customer\Wishlist_Controller;
use Webkul\Admin\Http\Controllers\Customers\Customer_Controller;
use Webkul\Admin\Http\Controllers\Customers\Customer_Group_Controller;
use Webkul\Admin\Http\Controllers\Customers\Gdpr_Controller;
use Webkul\Admin\Http\Controllers\Customers\Review_Controller;
/**
 * Customers routes.
 */
Route::prefix('customers')->group(function () {
     ...
     */
    Route::controller(Customer_Controller::class)->group(function () {
        ...
        Route::controller(Wishlist_Controller::class)->group(function () {
        ...
        Route::controller(Compare_Controller::class)->group(function () {
        ...
        Route::controller(Cart_Controller::class)->prefix('{id}/cart')->group(function () {
     ...
     */
    Route::controller(Address_Controller::class)->group(function () {
     ...
     */
    Route::controller(Review_Controller::class)->prefix('reviews')->group(function () {
     ...
     */
    Route::controller(Customer_Group_Controller::class)->prefix('groups')->group(function () {
    ...
    Route::controller(Gdpr_Controller::class)->prefix('gdpr')->group(function () {
