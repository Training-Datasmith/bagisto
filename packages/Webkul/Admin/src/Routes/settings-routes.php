...
use Webkul\Admin\Http\Controllers\Settings\Channel_Controller;
use Webkul\Admin\Http\Controllers\Settings\Currency_Controller;
use Webkul\Admin\Http\Controllers\Settings\Data_Transfer\Import_Controller;
use Webkul\Admin\Http\Controllers\Settings\Exchange_Rate_Controller;
use Webkul\Admin\Http\Controllers\Settings\Inventory_Source_Controller;
use Webkul\Admin\Http\Controllers\Settings\Locale_Controller;
use Webkul\Admin\Http\Controllers\Settings\Role_Controller;
use Webkul\Admin\Http\Controllers\Settings\Tax\Tax_Category_Controller;
use Webkul\Admin\Http\Controllers\Settings\Tax\Tax_Rate_Controller;
use Webkul\Admin\Http\Controllers\Settings\Theme_Controller;
use Webkul\Admin\Http\Controllers\Settings\User_Controller;
/**
 * Settings routes.
 */
Route::prefix('settings')->group(function () {
     ...
     * Channels routes.
     */
    Route::controller(Channel_Controller::class)->prefix('channels')->group(function () {
     ...
     * Currencies routes.
     */
    Route::controller(Currency_Controller::class)->prefix('currencies')->group(function () {
     ...
     */
    Route::controller(Exchange_Rate_Controller::class)->prefix('exchange-rates')->group(function () {
     ...
     * Locales routes.
     */
    Route::controller(Locale_Controller::class)->prefix('locales')->group(function () {
     ...
     */
    Route::controller(Inventory_Source_Controller::class)->prefix('inventory-sources')->group(function () {
    ...
    Route::prefix('taxes')->group(function () {
         ...
         */
        Route::controller(Tax_Category_Controller::class)->prefix('categories')->group(function () {
         ...
         * Tax rates routes.
         */
        Route::controller(Tax_Rate_Controller::class)->prefix('rates')->group(function () {
     ...
     * Roles routes.
     */
    Route::controller(Role_Controller::class)->prefix('roles')->group(function () {
     ...
     * Users routes.
     */
    Route::controller(User_Controller::class)->prefix('users')->group(function () {
    ...
    Route::controller(Theme_Controller::class)->prefix('themes')->group(function () {
    ...
    Route::prefix('data-transfer')->group(function () {
         ...
         * Import routes.
         */
        Route::controller(Import_Controller::class)->prefix('imports')->group(function () {
