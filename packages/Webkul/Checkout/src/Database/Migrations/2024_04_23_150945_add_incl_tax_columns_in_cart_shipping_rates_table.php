...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('cart_items')->update(['price_incl_tax' => DB::raw('price'), 'base_price_incl_tax' => DB::raw('base_price')]);
    }
    /**
    ...
    public function down(): void
    {
        Schema::table('cart_shipping_rates', function (Blueprint $table) {
            ...
            $table->drop_column('base_tax_amount');
            $table->drop_column('tax_amount');
            $table->drop_column('tax_percent');
        });
    }
};